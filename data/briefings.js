window.MORNING_BRIEFINGS = [
  {
    date: "2026-06-23-test",
    displayDate: "2026年6月23日（千问发布测试版）",
    scope: "全球新闻｜科技与财经优先｜临时测试",
    image: "assets/morning-briefing-2026-06-23-test.png",
    summary: "这是千问自动生成链路的临时发布测试卡片，不覆盖正式6月23日简报。内容聚焦格林斯潘逝世、SpaceX算力协议、英伟达Rubin液冷数据中心、AI与长期通胀、以及卡特彼勒受AI基建行情推动创下股价里程碑。",
    focus: [
      "宏观人物、AI基建大单、数据中心环保、AI通胀逻辑和工业股AI溢出共同构成今日主线。",
      "SpaceX算力协议和英伟达液冷设计显示，AI竞争正在快速转化为数据中心、电力、冷却和工业设备需求。",
      "格林斯潘逝世与AI通胀讨论把市场注意力拉回货币政策框架：AI既可能提高生产率，也可能推高算力、能源和资本开支成本。"
    ],
    items: [
      {
        ...
        summary: "前美联储主席艾伦·格林斯潘去世，享年100岁。他曾在1987年至2006年长期执掌美联储，其政策遗产重新引发市场对央行独立性、宽松货币政策和金融监管失误的讨论。",
        why: "格林斯潘是全球金融体系的标志性人物，其政策遗产对当前美联储在通胀、AI生产率冲击和资产价格高位下的决策仍有参照意义。",
        watch: "关注市场对其政策遗产的再评价，以及当前美联储在通胀粘性和AI投资热潮之间如何校准利率路径。"
      },
      {
        title: "SpaceX与开源AI初创公司Reflection签署高达63亿美元算力协议",
        region: "美国、SpaceX、Reflection AI、AI算力",
        sources: ["WSJ", "Axios"],
        summary: "SpaceX与英伟达支持的开源AI初创公司Reflection达成数据中心算力协议，合同价值最高约63亿美元。Reflection将使用SpaceX Colossus相关算力，以支撑开源模型训练和竞争。",
        why: "AI算力正成为前沿模型公司的核心瓶颈，SpaceX从航天基础设施延伸到AI数据中心，也说明科技巨头之间正在同时扮演投资者、供应商和客户。",
        watch: "关注Colossus数据中心交付进度、Reflection开源模型表现，以及SpaceX数据中心收入是否成为新的估值支柱。"
      },
      {
        title: "英伟达展示Rubin架构液冷数据中心设计，以高运行温度换取水资源节约",
        region: "美国、Nvidia、数据中心、液冷",
        sources: ["The Verge"],
        summary: "英伟达介绍Rubin世代全液冷参考设计，称通过让AI服务器在更高温度下运行，可显著减少传统冷却塔用水，回应公众对AI数据中心水资源和能源消耗的担忧。",
        why: "AI扩张面临的不只是芯片供应，还有电力、水资源、散热和地方审批等物理约束。液冷与热管理能力正在成为下一代AI基础设施竞争点。",
        watch: "关注Rubin液冷方案的客户采纳率、部署成本，以及各地政府是否对数据中心水耗出台更严格限制。"
      },
      {
        title: "经济学家警告：AI可能成为推高长期通胀的新变量",
        region: "全球、宏观经济、AI基础设施",
        sources: ["Marketplace", "MarketWatch"],
        summary: "市场讨论开始从“AI提升生产率、压低成本”的单一叙事，转向AI算力垄断、能源需求、资本开支和服务价格重估可能带来的结构性通胀压力。",
        why: "如果AI基建成本通过电价、云服务、企业软件和资本成本传导，长期利率和央行通胀模型都可能需要重新纳入AI相关变量。",
        watch: "关注美联储和主要央行是否在通胀预测中讨论AI能源与算力成本，以及科技公司资本开支能否被实际收入覆盖。"
      },
      {
        title: "卡特彼勒股价突破1000美元里程碑，AI基建热潮席卷传统工业股",
        region: "美国、工业股、AI数据中心",
        sources: ["MarketWatch"],
        summary: "卡特彼勒股价首次突破1000美元，成为道指今年表现最强股票之一。市场将其上涨与AI数据中心建设带来的电力、发动机、涡轮和重型设备需求联系起来。",
        why: "AI行情正在从芯片和云软件扩散到电力设备、工业机械和基础设施，传统工业企业也开始被重新纳入AI资本开支叙事。",
        watch: "关注卡特彼勒和其他工业巨头后续订单，尤其是数据中心电力、备用发电和重型设备需求是否真正兑现。"
      }
    ],
    sourceLinks: [
      ...
      "https://www.marketwatch.com/story/this-bull-market-isnt-going-to-end-because-of-fed-rate-hikes-under-warsh-8f63fa85",
      "https://www.marketwatch.com/story/caterpillars-stock-hits-a-milestone-as-roaring-industrials-rally-sweeps-up-wall-street-391057f7"
    ]
  },
  {
    date: "2026-06-23",
